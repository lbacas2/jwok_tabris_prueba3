...
jsw.event.EventHandlerUtil = {

  // TODO [tb] : integrate jsw.html.EventRegistration
  _lastUpDownType : {},
  _lastKeyCode : null,
  ...
  applyBrowserFixes  : jsw.util.Variant.select( "qx.client", {
    "gecko" : function() {
      // Fix for bug 295475:
      ...
      jsw.html.EventRegistration.addEventListener( docElement,
                                                  "mousedown",
  ...
  getDomEvent : jsw.util.Variant.select( "qx.client", {
  ...
  getDomTarget : jsw.util.Variant.select( "qx.client", {
    ...
    "webkit" : function( vDomEvent ) {
      ...
      if( vNode && ( vNode.nodeType == jsw.html.Nodes.TEXT ) ) {
  ...
  getOriginalTargetObject : function( vNode ) {
    ...
    // Walk up the tree and search for an jsw.widgets.base.Widget
    try {
      while( vNode != null && vNode.jswWidget == null )       {
        vNode = vNode.parentNode;
      }
    } catch( vDomEvent ) {
      vNode = null;
    }
    return vNode ? vNode.jswWidget : null;
  },
  ...
  getOriginalTargetObjectFromEvent : function( vDomEvent, vWindow ) {
    ...
    if( vWindow ) {
      ...
      {
        return vDocument.body.jswWidget;
      }
    }
  ...
  handleFocusedChild : function( target ) {
    if( target.getEnabled() && !( target instanceof jsw.widgets.base.ClientDocument ) ) {
      jsw.widgets.util.FocusHandler.mouseFocus = true;
      var root = target.getFocusRoot();
      if( root ) {
        jsw.event.EventHandler.setFocusRoot( root );
  ...
  getKeyCode : jsw.util.Variant.select( "qx.client", {
  ...
  getCharCode : jsw.util.Variant.select( "qx.client", {
    "default" : function( event ) {
  ...
  getEventPseudoTypes : jsw.util.Variant.select( "qx.client", {
  ...
  mustRestoreKeypress  : jsw.util.Variant.select( "qx.client", {
  ...
  isNonPrintableKeyCode  : jsw.util.Variant.select( "qx.client", {
