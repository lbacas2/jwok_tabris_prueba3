 ...
 * event is fired.
 */
jsw.qx.Class.define("jsw.html.ImagePreloaderSystem",
{
  ...
  */
  ...
  construct : function(vPreloadList, vCallBack, vCallBackScope)
  {
    ...
    if( vPreloadList instanceof Array ) {
      this._list = jsw.util.Objects.fromArray( vPreloadList );
    } else {
      this._list = vPreloadList;
    }

    // Create timer
    this._timer = new jsw.client.Timer( 3000 );
  ...
  */
  ...
  members :
  {
    ...
    */
    ...
    start : function()
    {
      if (jsw.util.Objects.isEmpty(this._list))
      {
      ...
      {
        var vPreloader = jsw.html.ImagePreloaderManager.getInstance().create( vSource );
