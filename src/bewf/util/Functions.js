 ...
 */
jsw.qx.Class.define("jsw.util.Functions",
{
  statics :
  {
     ...
     * @param varargs {...*} multiple arguments which should be static arguments for the given function
    ...
    bind: function( fcn, self, varargs ) {
      ...
      if( arguments.length > 2 ) {
        ...
        var wrap = function() {
          fcn.context = self;
          var ret = fcn.apply(self, args.concat(jsw.util.Arrays.fromArguments(arguments)));
          fcn.context = null;
          return ret;
        };
      } else {
