...
jsw.util.Variant = {
   ...
   * var f = jsw.util.Variant.select( "qx.client", {
   *   "gecko": function() { ... },
   ...
   *
   * <pre class='javascript'>
   * if (jsw.util.Variant.isSet("qx.client", "mshtml")) {
   *   // some Internet Explorer specific code
   * } else if(jsw.util.Variant.isSet("qx.client", "opera")){
   *   // Opera specific code
   * } else {
...
jsw.util.Variant.define( "qx.debug", "off" );
jsw.util.Variant.__init();
