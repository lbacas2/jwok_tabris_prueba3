...
jsw.remote.Request = function( url, method, responseType ) {
  this._url = url;
  this._method = method;
  this._async = true;
  this._success = null;
  ...
  this._request = jsw.remote.Request.createXHR();
};

jsw.remote.Request.createXHR = function() {
  return new XMLHttpRequest();
};

jsw.remote.Request.prototype = {
