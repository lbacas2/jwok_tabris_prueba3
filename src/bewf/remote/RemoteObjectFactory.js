...
var ObjectManager = jsw.remote.ObjectRegistry;

jsw.remote.RemoteObjectFactory = { // TODO [tb] : merge with Connection.js? (not a factory)
  ...
  _getRemoteObject : function( id ) {
    if( this._db[ id ] == null ) {
      this._db[ id ] = new jsw.remote.RemoteObject( id );
