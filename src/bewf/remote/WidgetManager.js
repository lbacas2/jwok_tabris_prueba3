 ...
 *
 */
jsw.qx.Class.define( "jsw.remote.WidgetManager", {
  ...
  statics : {
    ...
    getInstance : function() {
      return jsw.runtime.Singletons.get( jsw.remote.WidgetManager );
    }
  ...
  members : {
    ...
    add : function( widget, id, isControl, adapter ) {
      ...
      jsw.remote.ObjectRegistry.add( id, widget, adapter );
    },
    ...
    remove : function( widget ) {
      ...
      jsw.remote.ObjectRegistry.remove( id );
    },
    ...
    findWidgetById : function( id ) {
      return jsw.remote.ObjectRegistry.getObject( id );
    },
    ...
    findIdByWidget : function( widget ) {
      return jsw.remote.ObjectRegistry.getId( widget );
    },
    ...
    setToolTip : function( widget, toolTipText ) {
      jsw.widgets.base.WidgetToolTip.setToolTipText( widget, toolTipText );
    },
