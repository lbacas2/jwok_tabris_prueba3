 ...
 */
jsw.qx.Class.define( "jsw.qx.Object", {

  extend : Object,

  construct : function() {
    this._hashCode = jsw.qx.Object.__availableHashCode++;
    if( this._autoDispose ) {
      // try to get a re-usable key
      this.__dbKey=jsw.qx.Object.__freeAvailableDbKeys.pop();
      if( !this.__dbKey ) {
        // no re-usable key found ==> append to registry
        this.__dbKey = jsw.qx.Object.__db.length;
        jsw.qx.Object.__db.push( this );
      } else {
        // re-use key
        jsw.qx.Object.__db[ this.__dbKey ] = this;
      }
    }
  },
  ...
  members : {
    ...
    set : function( data, value ) {
      var setter = jsw.qx.Property.$$method.set;
     ...
     */
    get : function( prop ) {
      var getter = jsw.qx.Property.$$method.get;
     ...
     */
    reset : function( prop ) {
      var resetter = jsw.qx.Property.$$method.reset;
      this[ resetter[ prop ] ]();
    },
    ...
    debug : jsw.util.Variant.select( "qx.debug", {
      "on" : function( msg ) {
    ...
    printStackTrace : jsw.util.Variant.select( "qx.debug", {
      "on" : function() {
     ...
     * Only works with jsw.qx.Object based objects e.g. Widgets.
     *
     * @param varargs {arguments} fields to dispose
     */
    ...
    __disposeObjectsDeepRecurser : function( obj, deep ) {
      // qooxdoo
      if( obj instanceof jsw.qx.Object ) {
        obj.dispose();
      }
      // Array
  ...
  destruct : function() {
    ...
    var clazz = this.constructor;
    var properties;
    var store = jsw.qx.Property.$$store;
    ...
    if( this.__dbKey != null ) {
      if( jsw.qx.Object.__disposeAll ) {
        jsw.qx.Object.__db[ this.__dbKey ] = null;
      } else {
        delete jsw.qx.Object.__db[ this.__dbKey ];
      }
      jsw.qx.Object.__freeAvailableDbKeys.push( this.__dbKey );
    }
  }
