 ...
 * given timeout.
 */
jsw.qx.Class.define("jsw.client.Timer",
{
  ...
  */
  ...
  construct : function(interval)
  {
    ...
    this.__oninterval = jsw.util.Functions.bind(this._oninterval, this);

    //Event instance to dispatch when interval fires
    this.__event = new jsw.event.Event("interval");
  ...
  */
  ...
  statics :
  {
    ...
    once : function(func, obj, timeout)
    {
      ...
      var timer = new jsw.client.Timer(timeout);
