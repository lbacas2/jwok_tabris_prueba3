 ...
 */
jsw.qx.Class.define("jsw.widgets.util.FocusHandler",
{
  ...
  members :
  {
    ...
    */
    ...
    _onkeyevent : function(container, ev)
    {
      ...
      jsw.widgets.util.FocusHandler.mouseFocus = false;
    ...
    compareTabOrder : function(c1, c2)
    {
      ...
      var y1 = jsw.html.Location.getTop(c1.getElement());
      var y2 = jsw.html.Location.getTop(c2.getElement());
      ...
      var x1 = jsw.html.Location.getLeft(c1.getElement());
      var x2 = jsw.html.Location.getLeft(c2.getElement());
    ...
    */
    ...
    _getAllAfter : function(parent, widget, arr)
    {
      ...
      for (var i=0; i<len; i++)
      {
        ...
        if (child.isDisposed() || !(child instanceof jsw.widgets.base.Parent) && !(child instanceof jsw.widgets.base.Terminator)) {
          continue;
        }
        ...
        if (!child.isFocusRoot() && child instanceof jsw.widgets.base.Parent) {
    ...
    _getAllBefore : function(parent, widget, arr)
    {
      ...
      for (var i=0; i<len; i++)
      {
        ...
        if (!(child instanceof jsw.widgets.base.Parent) && !(child instanceof jsw.widgets.base.Terminator)) {
          continue;
        }
