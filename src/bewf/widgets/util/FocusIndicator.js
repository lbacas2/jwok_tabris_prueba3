...
jsw.qx.Class.define( "jsw.widgets.util.FocusIndicator", {
  ...
  statics : {
    ...
    getInstance : function() {
      return jsw.runtime.Singletons.get( jsw.widgets.util.FocusIndicator );
    }
  ...
  members : {
    ...
    _createTheme : function( widget, cssSelector, focusElement ) {
      ...
      var tv = new jsw.theme.ThemeValues( states );
      var border = tv.getCssBorder( cssSelector, "border" );
      var opacity = tv.getCssFloat( cssSelector, "opacity" );
      var hasValidBorder = border instanceof jsw.html.Border;
    ...
    _styleFocusIndiactorOpacity : jsw.util.Variant.select( "qx.client", {
