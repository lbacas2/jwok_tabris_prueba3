 ...
 */
jsw.qx.Class.define("jsw.widgets.base.Parent",
{
  ...
  */
  ...
  properties :
  {
    ...
    focusHandler :
    {
      check : "jsw.widgets.util.FocusHandler",
  ...
  */
  ...
  members :
  {
    ...
    */
     ...
     *
     * @type member
     * @return {jsw.widgets.util.FocusHandler} TODOC
     */
    ...
    activateFocusRoot : function()
    {
      ...
      this._focusHandler = new jsw.widgets.util.FocusHandler(this);
    ...
    _applyFocusedChild : function(value, old)
    {
      ...
      if (jsw.qx.Class.isDefined("jsw.widgets.util.PopupManager") && vFocusValid)
      {
        var vMgr = jsw.widgets.util.PopupManager.getInstance();
      ...
      if (vBlurValid)
      {
        ...
        {
          var vEventObject = new jsw.event.FocusEvent("focusout", old);
      ...
      if (vFocusValid)
      {
        ...
        {
          // Dispatch FocusIn
          var vEventObject = new jsw.event.FocusEvent("focusin", value);
      ...
      if (vBlurValid)
      {
        ...
        // Dispatch Blur
        var vEventObject = new jsw.event.FocusEvent("blur", old);
        ...
        // TODO: revisar!!!!
        /*
        var vMgr = jsw.widgets.util.ToolTipManager.getInstance();
      ...
      if (vFocusValid)
      {
        ...
        // Dispatch Focus
        var vEventObject = new jsw.event.FocusEvent("focus", value);
    ...
    */
     ...
     *
     * @type member
     * @return {jsw.widgets.base.BoxLayout} TODOC
     */
    /*
    _createLayoutImpl : function() {
      return new jsw.widgets.util.CanvasLayoutImpl( this);
    },
    */
     ...
     *
     * return {jsw.widgets.util.LayoutImpl}
     *
     * @type member
     * @return {var} TODOC
     */
    ...
    */
     ...
     *
     * @type member
     * @return {jsw.widgets.base.Widget[]} all children
     */
     ...
     *
     * @type member
     * @param vChild {jsw.widgets.base.Widget} Child widget to get the index for
     ...
     *
     * @type member
     * @param vWidget {jsw.widgets.base.Widget} The widget which should be checked.
    ...
    */
     ...
     *
     * @type member
     * @return {jsw.widgets.base.Widget[]} all visible children
     */
    ...
    */
     ...
     *
     * @type member
     * @param varargs {jsw.widgets.base.Widget} variable number of widgets to add
    ...
    addAt : function(vChild, vIndex)
    {
      ...
      if (vChild.getParent() == this)
      {
        ...
        {
          if (vOldIndex != -1) {
            jsw.util.Arrays.removeAt(vChildren, vOldIndex);
          }

          jsw.util.Arrays.insertAt(vChildren, vChild, vIndex);
...
//            this.getLayoutImpl().updateChildrenOnMoveChild(vChild, vIndex, vOldIndex);
    ...
    */
     ...
     *
     * @type member
     * @param varargs {jsw.widgets.base.Widget} variable number of widgets to remove
     */
    remove : function(varargs)
    {
      ...
      for (var i=0, l=arguments.length; i<l; i++)
      {
        ...
        if (!(vWidget instanceof jsw.widgets.base.Parent) && !(vWidget instanceof jsw.widgets.base.Terminator)) {
    ...
    */
    ...
    getFirstChild : function() {
      return jsw.util.Arrays.getFirst(this.getChildren()) || null;
    },
    ...
    getFirstVisibleChild : function() {
      return jsw.util.Arrays.getFirst(this.getVisibleChildren()) || null;
    },
    ...
    getFirstActiveChild : function(vIgnoreClasses) {
      return jsw.widgets.base.Widget.getActiveSiblingHelper(null, this, 1, vIgnoreClasses, "first") || null;
    },
    ...
    */
    ...
    getLastChild : function() {
      return jsw.util.Arrays.getLast(this.getChildren()) || null;
    },
    ...
    getLastVisibleChild : function() {
      return jsw.util.Arrays.getLast(this.getVisibleChildren()) || null;
    },
    ...
    getLastActiveChild : function(vIgnoreClasses) {
      return jsw.widgets.base.Widget.getActiveSiblingHelper(null, this, -1, vIgnoreClasses, "last") || null;
    },
...
// this.getLayoutImpl().layoutChild(vChild, vChanges);
      ...
      if (vChanges.initial)
      {
        ...
        jsw.widgets.base.Widget.addToGlobalDisplayQueue(vChild);
      }
 ...
 // TODO: Remove
    ...
    */
    ...
    remapChildrenHandlingTo : function(vTarget)
    {
      ...
      {
        s = t[i];
        this[s] = new Function(jsw.widgets.base.Parent.prototype._remapStart + s + jsw.widgets.base.Parent.prototype._remapStop);
      }
    }
  },
