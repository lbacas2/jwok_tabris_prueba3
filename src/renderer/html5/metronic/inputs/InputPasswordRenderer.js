jsw.qx.Class.define( "renderer.html5.metronic.InputPasswordRenderer", {

	extend : renderer.html5.base.InputPasswordRenderer,
...
renderer.base.RendererHandlerRegistry.getInstance().add("jsw.widgets.InputPassword",  {
	create : function() {
		return new renderer.html5.metronic.InputPasswordRenderer();
	}
});
